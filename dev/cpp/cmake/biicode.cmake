...
SET(BII_DEPS_INCLUDES_SYSTEM OFF)
...
function(BII_ADD_INCLUDE_DIRECTORIES TARGET TRANSITIVE)
	IF(NOT ARGV2)
		return()
	ENDIF()
	SET(bii_include_dirs ${ARGV2})
	if(NOT BII_DEPS_INCLUDES_SYSTEM)
		target_include_directories(${TARGET} ${TRANSITIVE} ${bii_include_dirs})
		return()
	endif()
	foreach(inc_path ${bii_include_dirs})
		if(${inc_path} MATCHES ${BII_DEPS_DIR})
    		target_include_directories( ${TARGET} SYSTEM ${TRANSITIVE} ${inc_path})
    	else()
    		target_include_directories( ${TARGET} ${TRANSITIVE} ${inc_path})
    	endif()
    endforeach()
endfunction()
...
function(BII_GENERATE_EXECUTABLE USER BLOCK FNAME BII_CMAKE_VERSION)
    ...
    BII_ADD_INCLUDE_DIRECTORIES(${exe_name} PUBLIC "${BII_${FNAME}_INCLUDE_PATHS}")
...
function(BII_GENERATE_LIB lib_name BII_CMAKE_VERSION)
    ...
    BII_ADD_INCLUDE_DIRECTORIES(${lib_name} ${TRANSITIVE} "${BII_LIB_INCLUDE_PATHS}")
